    ...
    <div class="card card-outline card-purple shadow-sm border-0">
        <div class="card-header bg-white py-3">
            <h3 class="card-title font-weight-bold text-dark mb-0">
                <i class="fas fa-list text-purple mr-2"></i> Listado de Documentos Turnados
            </h3>
        </div>
                                    ...
                                    <div class="btn-grid-actions">
                                        ...
                                        <div class="btn-group-row">
                                            ...
                                            @if (auth()->user()->nivel == 4)
                                                {{-- DAR RESPUESTA --}}
                                                <a href="{{ route('documentosRecibidosTurnadosRespuestaCreate', $documento->id) }}" 
                                                   class="btn btn-outline-info btn-action"
                                                   data-toggle="tooltip" title="Dar respuesta">
